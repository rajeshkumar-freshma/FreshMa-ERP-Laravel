...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('sales_order_return_expenses', function (Blueprint $table) {
            ...
            $table->tinyInteger('is_billable')->nullable()->default(0);
    ...
    {
        Schema::dropIfExists('sales_order_return_expenses');
    }
};
