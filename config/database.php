...
return [
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            // 'options' => [
            //     PDO::ATTR_TIMEOUT => 600, // Timeout in seconds
            // ],
        ...
        'sqlsrv_activity_log' => [
            'driver' => 'mysql', // MySQL local sever connection driver
            // 'driver' => 'sqlsrv',   //MsSQL live  server connection driver
            'url' => env('DATABASE_URL_ACTIVITY'),
            'host' => env('DB_HOST_ACTIVITY', 'localhost'),
            'port' => env('DB_PORT_ACTIVITY', '1433'),
            'database' => env('DB_DATABASE_ACTIVITY', 'forge'),
            'username' => env('DB_USERNAME_ACTIVITY', 'forge'),
