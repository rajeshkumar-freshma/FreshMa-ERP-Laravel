                ...
                <div class="card-body">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach ($transport_trackings as $transport_tracking )
                            <tr>
                                <!--begin::Product ID-->
                    ...
                    @if (isset($transport_trackings) && count($transport_trackings) > 0)
                    <div class="d-flex justify-content-between mx-0 row mt-1">
                        <div class="col-sm-12 col-md-6">
                            Showing {{ $transport_trackings->firstItem() }} to {{ $transport_trackings->lastItem() }} of
                            {{ $transport_trackings->total() }} entries
                        </div>
                        <div class="col-sm-12 col-md-6 float-right">
                            {{ $transport_trackings->withQueryString()->links('vendor.pagination.custom') }}
                        </div>
                    </div>
                    @endif
                    <!--end::Table-->
