                ...
                <div class="card-body">
                    ...
                    <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                        ...
                        <tbody class="fw-bold text-gray-600">
                            @foreach (@$purchase_return_transport_trackings as $transport_tracking )
                            <tr>
                                <!--begin::Product ID-->
                    ...
                    @if (isset($purchase_return_transport_trackings) && count($purchase_return_transport_trackings) > 0)
                    <div class="d-flex justify-content-between mx-0 row mt-1">
                        <div class="col-sm-12 col-md-6">
                            Showing {{ @$purchase_return_transport_trackings->firstItem() }} to {{ @$purchase_return_transport_trackings->lastItem() }} of
                            {{ @$purchase_return_transport_trackings->total() }} entries
                        </div>
                        <div class="col-sm-12 col-md-6 float-right">
                            {{ @$purchase_return_transport_trackings->withQueryString()->links('vendor.pagination.custom') }}
                        </div>
                    </div>
                    @endif
                    <!--end::Table-->
