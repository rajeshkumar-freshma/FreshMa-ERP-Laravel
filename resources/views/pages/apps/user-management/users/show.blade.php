            ...
            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-8">
                ...
                <li class="nav-item ms-auto">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg-light-primary fw-semibold py-4 w-250px fs-6" data-kt-menu="true">
                        ...
                        <!--begin::Menu item-->
                        <div class="menu-item px-5">
                            <a href="#" class="menu-link text-danger px-5">Delete Vendor</a>
                        </div>
                        <!--end::Menu item-->
                    </div>
                    <!--end::Menu-->
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        ...
                                        <label class="form-check-label" for="kt_modal_update_email_notification_3">
                                            ...
                                            <div class="text-gray-600">Receive a notification if a payment is disputed by a Vendor and for dispute resolutions.</div>
                                        </label>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Checkbox-->
                                ...
                                <div class="d-flex">
                                    ...
                                    <div class="form-check form-check-custom form-check-solid">
                                        ...
                                        <label class="form-check-label" for="kt_modal_update_email_notification_6">
                                            ...
                                            <div class="text-gray-600">Receive a notification if a Vendor sends an incorrect amount to pay their invoice.</div>
                                        </label>
                                        <!--end::Label-->
                                    </div>
                                    <!--end::Checkbox-->
