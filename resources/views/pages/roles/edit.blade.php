<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Edit Role Setup'])
        <!--end::Card header-->

        <!--begin::Content-->
        <div id="roles" class="collapse show">
            <form id="roles_form" class="form" method="POST"
                action="{{ route('admin.role-management.roles.update', @$role->id) }}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <!--begin::Card body-->
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="role_name" id="role_name"
                                    ...
                                    placeholder="Name" value="{{ old('role_name', @$role->name) }}" required readonly />
