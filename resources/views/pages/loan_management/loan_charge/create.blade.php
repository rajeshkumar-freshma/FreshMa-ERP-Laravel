<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Loan Charges',
            'menu_1_link' => route('admin.loan-charges.index'),
            'menu_2' => 'Add Loan Charges',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Loan Charges'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="loan_charges" class="collapse show">
            <!--begin::Form-->
            <form id="loan_charges_form" class="form" method="POST" action="{{ route('admin.loan-charges.store') }}"
