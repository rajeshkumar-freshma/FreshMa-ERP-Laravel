<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            ...
            'menu_2' => 'Add Re Payments',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Loan Repayment'])
        <!--begin::Card header-->
        <!--begin::Content-->
        <div id="loan_repayment" class="collapse show">
            <!--begin::Form-->
            <form id="loan_repayment_form" class="form" method="POST" action="{{ route('admin.loan-repayment.store') }}"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-7">
                            <div class="mb-5">
                                ...
                                <select name="loan_id" id="loan_id"
                                    ...
                                    class="form-select form-select-sm form-select-solid" data-allow-clear="true" onchange="getLoanDetails()">
                                    <option value="">Select Loan Id</option>
                                    @foreach (@$loanTransactions as $key => $details)
                                        <option value="{{ $details->id }}"
                                            {{ $details->id == old('loan_id') ? 'selected' : '' }}
                                            class="optionGroup">
                                            {{ $details->loan_code }}
                                        </option>
                                    @endforeach
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    <input id="payment_date" type="text"
                                        ...
                                        name="payment_date" placeholder="Instalment Date" value="{{ old('payment_date') }}" />
                        ...
                        <div class="col-md-7">
                            <div class="mb-5">
                                ...
                                <input type="text" name="instalment_amount" value="{{ old('instalment_amount') }}"
                        ...
                        <div class="col-md-7">
                            <div class="mb-5">
                                ...
                                <input type="text" name="pay_amount" value="{{ old('pay_amount') }}"
                        ...
                        <div class="col-md-7">
                            <div class="mb-5">
                                ...
                                <input type="text" name="due_amount" value="{{ old('due_amount') }}"
