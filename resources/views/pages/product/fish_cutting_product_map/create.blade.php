<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Product Fish Cutting Mapping',
            'menu_1_link' => route('admin.fish-cutting-product-map.index'),
            'menu_2' => 'Add Product Fish Cutting Mapping',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Fish Cutting Product Mapping'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="fish_cutting_product_details" class="collapse show">
            <!--begin::Form-->
            <form id="fish_cutting_product_details_form" class="form" method="POST" action="{{ route('admin.fish-cutting-product-map.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row mb-3">
                                ...
                                <div class="input-group input-group-sm flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select name="main_product_id" id="main_product_id" aria-label="{{ __('Select Product') }}" data-control="select2" data-placeholder="{{ __('Select Product..') }}" class="form-select form-select-sm form-select-solid" data-allow-clear="true" required>
                                            ...
                                            <option data-kt-flag="{{ $product->id }}" value="{{ $product->id }}" {{ $product->id == old('main_product_id') ? 'selected' : '' }}>{{ $product->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="number" name="wastage_percentage" class="form-control form-control-sm form-control-solid" id="wastage_percentage" value="{{ old('wastage_percentage') }}" placeholder="Enter Percentage" step="any" required>
                        ...
                        <div class="row product_div">
                            <div class="col-md-3">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-sm flex-nowrap">
                                        <span class="input-group-text border-0"><i class="fas fa-home"></i></span>
                                        <div class="overflow-hidden flex-grow-1">
                                            <select name="products[0][product_id]" id="product_id" aria-label="{{ __('Select Product') }}" data-control="select2" data-placeholder="{{ __('Select Product..') }}" class="form-select form-select-sm form-select-solid" data-allow-clear="true" required>
                                                <option value="">{{ __('Select Product..') }}</option>
                                                @foreach (@$products as $key => $product)
                            ...
                            <div class="col-md-3">
                                <div class="mb-5">
                                    ...
                                    <div class="input-group input-group-sm flex-nowrap">
                                        <span class="input-group-text border-0"><i class="fas fa-home"></i></span>
                                        <div class="overflow-hidden flex-grow-1">
                                            <select name="products[0][type]" id="type" aria-label="{{ __('Select Type') }}" data-control="select2" data-placeholder="{{ __('Select Type..') }}" class="form-select form-select-sm form-select-solid" data-allow-clear="true" required>
                            ...
                            <div class="col-md-3">
                                <div class="mb-5">
                                    ...
                                    <input type="number" name="products[0][percentage]" class="form-control form-control-sm form-control-solid" id="percentage" placeholder="Enter Percentage" step="any" required>
                                    @if ($errors->has('percentage'))
                                    <span class="fv-plugins-message-container invalid-feedback" role="alert">
                                        <strong>{{ $errors->first('percentage') }}</strong>
                                    </span>
