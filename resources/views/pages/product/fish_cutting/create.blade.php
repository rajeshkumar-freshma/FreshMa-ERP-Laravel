<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Fish Cutting',
            'menu_1_link' => route('admin.fish-cutting.index'),
            'menu_2' => 'Add Fish Cutting',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Fish Cutting'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="fish_cutting" class="collapse show">
            <!--begin::Form-->
            <form id="fish_cutting_form" class="form" method="POST" action="{{ route('admin.fish-cutting.store') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="weight"
                                    ...
                                    value="{{ old('weight') }}" placeholder="Enter" step="any" required>
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    <input id="cutting_date" type="button"
                                        ...
                                        name="cutting_date" value="" required />
