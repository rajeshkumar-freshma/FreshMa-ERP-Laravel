<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Daily Product Price Update',
            'menu_1_link' => route('admin.fish-price-update.index'),
            'menu_2' => 'Add Daily Product Price Update',
        ])
    @endsection
    <!--begin::Basic info-->
    <form id="daily_product_price_update" class="form" method="GET"
        action="{{ route('admin.fish-price-update.create') }}" enctype="multipart/form-data">
        @csrf
        @method('get')
        <div class="card mt-2">
            <!--begin::Card header-->
                                ...
                                <div class="input-group input-group-sm flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select name="store_id" id="store_id" aria-label="{{ __('Select Store') }}"
                                            ...
                                            <option value="all" {{ 'all' == @$store_id ? 'selected' : '' }} >{{ __('All Store') }}</option>
                            ...
                            <div class="mb-5">
                                <div class="input-group">
                                    <div class="d-flex justify-content-right py-6">
                                        ...
                                        <button type="submit" class="btn btn-sm btn-secondary me-2 filter_button"
                                            name="can_proceed_previous_date" id="can_proceed_previous_date"
                                            value="1">{{ __('Previous Price') }}</button>
            ...
            <div class="card mt-2">
                ...
                <div id="product">
                                        ...
                                        <div class="input-group input-group-sm flex-nowrap">
                                            ...
                                            <div class="overflow-hidden flex-grow-1">
                                                <input type="text"
                                                    ...
                                                    name="prices[]" id="prices[]" value="{{ $product->price }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @include('pages.partials.form_footer', [
                        'is_save' => true,
                        'back_url' => route('admin.fish-price-update.index'),
                    ])
                    <!--end::Actions-->
                </div>
            </div>
