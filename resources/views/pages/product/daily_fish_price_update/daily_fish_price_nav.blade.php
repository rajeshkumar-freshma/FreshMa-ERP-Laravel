...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
    ...
    <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
        ...
        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
            <!--begin::Title-->
            <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Daily Store
                Stock Updated Order</h1>
        </div>
        <!--end::Page title-->
    </div>
            ...
            <div class="col-md-12">
                ...
                <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold flex-wrap">
                    ...
                    <li class="nav-item mt-2">
                        <a class="nav-link text-active-primary ms-0 me-10 py-5  {{ request()->routeIs('admin.fish-price-update.show') ? 'active' : '' }}"
                            href="{{ route('admin.fish-price-update.show', @$daily_fish_price_dates->id) }}">Overview</a>
                    </li>
                    <!--end::Nav item-->
                </ul>
                <!--begin::Navs-->
