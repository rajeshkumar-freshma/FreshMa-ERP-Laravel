                            ...
                            <select name="status" id="status" aria-label="{{ __('Select Status') }}"
                                ...
                                @foreach (config('app.statusinactive') as $key => $value)
                                    <option data-kt-flag="{{ $value['value'] }}" value="{{ $value['value'] }}"
                                        {{ $value['value'] == old('status') ? 'selected' : '' }}>{{ $value['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        </div>
                                            ...
                                            <select name="category_id[]" id="category_id"
                                                ...
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}"
                                                        {{ old('category_id') != null && in_array($category->id, old('category_id')) ? 'selected' : '' }}
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                            ...
                                            <select name="item_type_id" id="item_type_id"
                                                ...
                                                @foreach ($item_types as $item_type)
                                                    <option value="{{ $item_type->id }}"
                                                        {{ $item_type->id == old('item_type_id') ? 'selected' : '' }}
                                ...
                                <div class="mb-5">
                                    <label for="unit_id" class="required form-label">{{ __('Unit') }}</label>
                                            ...
                                            <select name="tax_id" id="tax_id"
                                                ...
                                                @foreach ($tax_rates as $tax_rate)
                                                    <option value="{{ $tax_rate->id }}"
                                                        {{ $tax_rate->id == old('tax_id') ? 'selected' : '' }}
