<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Accounts',
            'menu_1_link' => route('admin.accounts.index'),
            'menu_2' => 'Add Accounts',
        ])
    @endsection
    @section('_toolbar')
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Accounts'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="bank" class="collapse show">
            <!--begin::Form-->
            <form id="bank_form" class="form" method="POST" action="{{ route('admin.accounts.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="name" value="{{ old('name') }}" class="form-control form-control-sm form-control-solid" id="name" placeholder="Enter Name" required />
                                @if ($errors->has('name'))
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="account_number" value="{{ old('account_number') }}" class="form-control form-control-sm form-control-solid" id="account_number" placeholder="Enter Account Number" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="form-control form-control-sm form-control-solid" id="bank_name" placeholder="Enter Bank Name" required/>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="branch_name" value="{{ old('branch_name') }}" class="form-control form-control-sm form-control-solid" id="branch_name" placeholder="Enter Branch Name" required />
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select name="account_type" id="account_type" aria-label="{{ __('Select account_type') }}" data-control="select2" data-placeholder="{{ __('Select Account Type..') }}" class="form-select form-select-sm form-select-solid" data-allow-clear="true" required>
                                            ...
                                            @foreach (config('app.account_type') as $key => $value)
                                                <option data-kt-flag="{{ $value['value'] }}" value="{{ $value['value'] }}" {{ $value['value'] == old('account_type') ? 'selected' : '' }}>{{ $value['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="bank_ifsc_code" value="{{ old('bank_ifsc_code') }}" class="form-control form-control-sm form-control-solid" id="bank_ifsc_code" placeholder="Enter Bank Ifsc Code" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="decimal" name="initial_balance" value="{{ old('initial_balance') }}" class="form-control form-control-sm form-control-solid" id="initial_balance" placeholder="Enter Bank Blance" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <textarea name="address" class="form-control form-control-sm form-control-solid" id="address" placeholder="Enter Address">{{ old('address') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <textarea name="notes" class="form-control form-control-sm form-control-solid" id="notes" placeholder="Enter Notes">{{ old('notes') }}</textarea>
                                @if ($errors->has('notes'))
                                    <span class="fv-plugins-message-container invalid-feedback" role="alert">
