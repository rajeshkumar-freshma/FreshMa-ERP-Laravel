                    ...
                    <div class="row mb-3">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select name="transaction_account" id="transaction_account"
                                            ...
                                            @foreach ($accounts as $key => $value)
                                                <option value="{{ $value->id }}" @selected(old('transaction_account') == $value->id)
                                                    {{-- {{ old('transaction_account') == $value->id ? 'selected' : '' }} --}}>
                                        ...
                                        <select name="transaction_type" id="transaction_type"
                                            ...
                                            @foreach (config('app.transaction_type') as $key => $value)
                                                <option data-kt-flag="{{ $value['value'] }}"
                                                    value="{{ $value['value'] }}" @selected(old('transaction_type') == $value['value'])
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="decimal" name="transaction_amount" value="{{ old('transaction_amount') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input id="transaction_date" type="text"
                                    ...
                                    placeholder="Enter Transaction Date" value="{{ old('transaction_date') }}" />
                            </div>
