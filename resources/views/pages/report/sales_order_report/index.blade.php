<x-default-layout>
    ...
    <div class="card">
        ...
        <div class="card-body pt-6">
            <form action="{{ route('admin.salesorderreportdata') }}" method="GET" enctype="multipart/form-data">
                @csrf
                @method('get')
                <div class="row">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="mb-5">
                            <div class="d-flex justify-content-right py-6">
                                ...
                                <a href="{{ route('admin.salesorderreportdata') }}"><button type="button"
        ...
        <!--begin::Card body-->
        <div class="card-body pt-6">
            @include('pages.report.sales_order_report._table')
        </div>
        <!--end::Card body-->
    </div>
    <!--end::Card-->
