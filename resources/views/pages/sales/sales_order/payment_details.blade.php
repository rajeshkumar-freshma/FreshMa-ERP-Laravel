        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card card-flush h-xl-100">
                ...
                <div class="card-body">
                    ...
                    @if (isset($sales_payments) && count($sales_payments) > 0)
                    <div class="d-flex justify-content-between mx-0 row mt-1">
                        <div class="col-sm-12 col-md-6">
                            Showing {{ $sales_payments->firstItem() }} to {{ $sales_payments->lastItem() }} of
                            {{ $sales_payments->total() }} entries
                        </div>
                        <div class="col-sm-12 col-md-6 float-right">
                            {{ $sales_payments->withQueryString()->links('vendor.pagination.custom') }}
                        </div>
                    </div>
                    @endif
                    <!--end::Table-->
