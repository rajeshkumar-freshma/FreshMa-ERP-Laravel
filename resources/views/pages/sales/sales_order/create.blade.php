<x-default-layout>
    ...
    <div id="item_details" class="collapse show">
        <!--begin::Form-->
        <form id="item_details_form" class="form" method="POST" action="{{ route('admin.sales-order.store') }}"
                ...
                <div class="card-body border-top px-9 py-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="mb-5">
                                @php
                                    $invoice_number = commoncomponent()->invoice_no('sale_order', 'VEN-');
                                @endphp
                                <label for="invoice_number"
                                    class="required form-label">{{ __('Invoice Number') }}</label>
                                <input type="text" class="form-control form-control-sm form-control-solid"
                                    id="invoice_number" name="invoice_number"
                                    value="{{ old('invoice_number', $invoice_number) }}" placeholder="VSR-" required />
                                        ...
                                        <select name="vendor_indent_request_id" id="indent_request"
                                            ...
                                            @foreach (@$vendor_indent_requests as $key => $vendor_indent_request)
                                                <option data-kt-flag="{{ $vendor_indent_request->id }}"
                                                    ...
                                                    {{ $vendor_indent_request->id == old('vendor_indent_request_id') ? 'selected' : '' }}>
