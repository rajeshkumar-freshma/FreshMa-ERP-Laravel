<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Daily Stock Update',
            'menu_1_link' => route('admin.daily-stock-update.index'),
            'menu_2' => 'Add Daily Stock Update',
        ])
    @endsection
    <!--begin::Basic info-->
                            ...
                            <div class="mb-5">
                                <div class="input-group mt-2">
                                    <div class="input-group d-flex justify-content-end">
                                        <button type="submit" class="btn btn-sm btn-success me-2 filter_button">{{ __('Filter') }}</button>
                                        <a href="{{ route('admin.daily-stock-update.create') }}"><button type="button" class="btn btn-sm btn-warning btn-active-light-primary me-2">{{ __('Clear Filter') }}</button></a>
                                    </div>
                                </div>
                            </div>
                        </div> --}}
                            ...
                            <div class="mb-5">
                                ...
                                <div class="input-group d-flex justify-content-end">
                                    <div class="mt-2">
                                        ...
                                        <a href="{{ route('admin.daily-stock-update.create') }}"><button
                                                type="button"
                            ...
                            <div class="input-group d-flex justify-content-end">
                                <div class="d-flex justify-content-end py-6">
                                    <button type="submit"
                                        ...
                                        id="submit_type1">{{ __('Daily Stock Update') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="input-group d-flex justify-content-end">
                                    <div class="d-flex justify-content-start py-6">
                                        ...
                                        <button type="submit"
                                            ...
                                            id="submit_type2">{{ __('Product Adjustment Update') }}</button>
                                    </div>
                                </div>
                            </div>
                        </div>
