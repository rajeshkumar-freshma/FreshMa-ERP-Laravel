<x-default-layout>
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            ...
            'menu_2' => 'Add Income/Expense Type',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Income & Expense Type'])
        <!--begin::Card header-->
        ...
        <div id="imcome_expense" class="collapse show">
            ...
            <form id="imcome_expense_form" class="form" method="POST"
                action="{{ route('admin.income-expense-type.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
