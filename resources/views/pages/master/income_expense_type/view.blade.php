<x-default-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title px-sm-4 px-md-1 px-lg-2 px-xl-3">Icome And Expense Details</h3>
        ...
        <div class="card-body">
            <div class="row text-center px-sm-4 px-md-1 px-lg-2 px-xl-3">
                    ...
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$incomeExpenseType->name != null ? @$incomeExpenseType->name : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        <div class="col-6 col-md-4 p-0">
                            <p class="font-weight-bold mb-0 p-2 bg-secondary">Type</p>
                        </div>
                        <div class="col-6 col-md-8">
                            @php
                                $incomeExpense = config('app.incomeexpense');
                                foreach ($incomeExpense as $key => $value) {
                                    if (@$incomeExpenseType->type == $value['value']) {
                                        $name = $value['name'];
                                        break;
                                    }
                                }
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$incomeExpenseType->status == 1 ? 'Active' : 'inactive' }}
                            </p>
                        </div>
                    </div>
                </div>
