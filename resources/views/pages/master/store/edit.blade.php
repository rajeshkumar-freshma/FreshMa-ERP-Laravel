<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Edit Store'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="store_details" class="collapse show">
            <!--begin::Form-->
            <form id="store_details_form" class="form" method="POST"
                action="{{ route('admin.store.update', $store->id) }}" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <!--begin::Card body-->
                    ...
                    <div class="row mb-3">
                                        ...
                                        <select name="warehouse_id" id="warehouse_id"
                                            ...
                                            @foreach ($warehouses as $key => $warehouse)
                                                <option data-kt-flag="{{ $warehouse->id }}"
                                                    value="{{ $warehouse->id }}"
                                                    {{ $warehouse->id == old('warehouse_id', $store->warehouse_id) ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="gst_number"
                                    value="{{ old('gst_number', $store->gst_number) }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <textarea name="address" class="form-control form-control-sm form-control-solid" id="address"
                                    placeholder="Enter Address">{{ old('address', $store->address) }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="pincode" value="{{ old('pincode', $store->pincode) }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="direction"
                                    value="{{ old('direction', $store->direction) }}"
                                        ...
                                        <select name="status" id="status" aria-label="{{ __('Select Status') }}"
                                            ...
                                            @foreach (config('app.statusinactive') as $key => $value)
                                                <option data-kt-flag="{{ $value['value'] }}"
                                                    value="{{ $value['value'] }}"
                                                    {{ $value['value'] == old('status', $store->status) ? 'selected' : '' }}>
                                                    {{ $value['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
