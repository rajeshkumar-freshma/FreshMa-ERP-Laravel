<x-default-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title px-sm-4 px-md-1 px-lg-2 px-xl-3">Warehouse Details</h3>
            ...
            <div class="row text-center px-sm-4 px-md-1 px-lg-2 px-xl-3">
                    ...
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->name != null ? $warehouse->name : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->slug != null ? $warehouse->slug : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        <div class="col-6 col-md-4 p-0">
                            <p class="font-weight-bold mb-0 p-2 bg-secondary">Code</p>
                        </div>
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->start_date != null ? $warehouse->start_date : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->phone_number != null ? $warehouse->phone_number : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->email != null ? $warehouse->email : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->address != null ? $warehouse->address : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->country->currency_code ?? ''}}-{{ $warehouse->country->name  != null ? $warehouse->country->name  : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->state->name != null ? $warehouse->state->name : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->city->name != null ? $warehouse->city->name : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->pincode != null ? $warehouse->pincode : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->latitude != null ? $warehouse->latitude : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->longitude != null ? $warehouse->longitude : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->direction != null ? $warehouse->direction : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ $warehouse->status == 1 ? 'Active' : 'Deactive' }}
                            </p>
                        </div>
                    </div>
                </div>
