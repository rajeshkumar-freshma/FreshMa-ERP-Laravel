<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Transport Type'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="item_details" class="collapse show">
            <!--begin::Form-->
            <form id="item_details_form" class="form" method="POST" action="{{ route('admin.transport-type.store') }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="transport_type"
                                    ...
                                    placeholder="Transport Type" value="{{ old('transport_type') }}" required />
                ...
                @include('pages.partials.form_footer', [
                    'is_save' => true,
                    'back_url' => route('admin.transport-type.index'),
                ])
                <!--end::Actions-->
            </form>
            <!--end::Form-->
