                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                            ...
                            <tbody class="fw-bold text-gray-600">
                                @foreach ($purchases as $purchase)
                                    <tr>
                                        <!--begin::Product ID-->
                                        <td class="text-end">{{ $purchase->purchase_order_number }}</td>
                                        <!--end::Product ID-->
                                        <!--begin::Date added-->
                                        <td class="text-end">{{ $purchase->total_request_quantity }}</td>
                                        <!--end::Date added-->
                                        <!--begin::Status-->
                                        <td class="text-end">
                                            <span
                                                class="badge py-3 px-4 fs-7 badge-light-primary">{{ $purchase->delivery_date }}</span>
                                        </td>
                                        <td class="text-end">
                                            <span
                                                class="badge py-3 px-4 fs-7 badge-light-primary">{{ $purchase->created_at }}</span>
                                        </td>
                                        <!--end::Status-->
                                        <!--begin::Qty-->
                                        <td class="text-end" data-order="58">
                                            <span class="text-dark fw-bold">{{ $purchase->total }}</span>
                                        </td>
                                        <td class="text-end" data-order="58">
                                            <span><a href="{{ route('admin.purchase-order.index') }}"><i
                                                        class='fas fa-eye'
