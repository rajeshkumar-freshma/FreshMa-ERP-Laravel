<x-default-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title px-sm-4 px-md-1 px-lg-2 px-xl-3">Supplier Details</h3>
            ...
            <div class="row text-center px-sm-4 px-md-1 px-lg-2 px-xl-3">
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$supplier->phone_number != null ? @$supplier->phone_number : '-' }}
                            </p>
                        ...
                        <div class="col-6 col-md-8">
                            @php
                                ...
                                foreach ($user_of_user_type as $key => $value) {
                                    if (@$supplier->user_type == $value['value']) {
                                        $usertype = $value['name'];
                                        break;
                                    } else {
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$supplier->user_info->company != null ? @$supplier->user_info->company : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$supplier->user_info->gst_number != null ? @$supplier->user_info->gst_number : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$supplier->status == 1 ? 'Active' : 'Deactive' }}
                            </p>
                        </div>
                    </div>
                </div>
