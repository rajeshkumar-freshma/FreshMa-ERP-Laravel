<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Tax Rate'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="tax_rate" class="collapse show">
            <!--begin::Form-->
            <form id="tax_rate_form" class="form" method="POST" action="{{ route('admin.tax-rate.store') }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="tax_name"
                                    ...
                                    placeholder="Tax Name" value="{{ old('tax_name') }}" required />
