<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Unit'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="unit" class="collapse show">
            <!--begin::Form-->
            <form id="unit_form" class="form" method="POST" action="{{ route('admin.unit.store') }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="unit_name"
                                    ...
                                    placeholder="Unit Name" value="{{ old('unit_name') }}" required />
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="unit_short_code"
                                    class="form-control form-control-solid form-control-lg mb-3 mb-lg-0"
                                    placeholder="Unit Short Code" value="{{ old('unit_short_code') }}" required />
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="base_unit"
                                    class="form-control form-control-solid form-control-lg mb-3 mb-lg-0"
                                    placeholder="Unit Base Name" value="{{ old('base_unit') }}" required />
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="allow_decimal"
                                    class="form-control form-control-solid form-control-lg mb-3 mb-lg-0"
                                    placeholder="Allow Decimal" value="{{ old('allow_decimal') }}" required />
                                        ...
                                        <select name="operator" id="operator" aria-label="{{ __('Select Operator') }}"
                                            ...
                                            @foreach (config('app.unit_oprators') as $key => $value)
                                                <option data-kt-flag="{{ $value['value'] }}"
                                                    value="{{ $value['value'] }}"
                                                    {{ $value['value'] == old('operator') ? 'selected' : '' }}>
                                                    {{ $value['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="operation_value"
                                    class="form-control form-control-solid form-control-lg mb-3 mb-lg-0"
                                    placeholder="Operation Value" value="{{ old('operation_value') }}" required />
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                ...
                                <input class="form-check-input w-45px h-30px" type="checkbox" id="status"
                                    name="default" value="1" {{ old('default', 0) ? 'checked' : '' }} />
