<x-default-layout>
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            ...
            'menu_2' => 'Edit Partnership Type',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Edit Partnership Type'])
        <!--begin::Card header-->
        ...
        <div id="partnership_type_details" class="collapse show">
            ...
            <form id="partnership_type_details_form" class="form" method="POST"
                action="{{ route('admin.partnership-type.update', $partnership_type->id) }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="partnership_name"
                                    ...
                                    value="{{ old('partnership_name', $partnership_type->partnership_name) }}"
                                    required />
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="number" name="partnership_percentage"
                                    ...
                                    value="{{ old('partnership_percentage', $partnership_type->partnership_percentage) }}"
                                    min="0" max="100" step="any" onkeypress="return /[0-9]/i.test(event.key)" required />
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                ...
                                <input class="form-check-input w-45px h-30px" type="checkbox" id="status"
                                    name="status" value="1"
                                    {{ old('status', $partnership_type->status) ? 'checked' : '' }} />
