<x-default-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title px-sm-4 px-md-1 px-lg-2 px-xl-3">Vendor Details</h3>
        ...
        <div class="card-body">
            <div class="row text-center px-sm-4 px-md-1 px-lg-2 px-xl-3">
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        <div class="col-6 col-md-4 p-0">
                            <p class="font-weight-bold mb-0 p-2 bg-secondary">User Code</p>
                        </div>
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$vendor->user_code != null ? @$vendor->user_code : '-' }}</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$vendor->phone_number != null ? @$vendor->phone_number : '-' }}
                            </p>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        <div class="col-6 col-md-4 p-0">
                            <p class="font-weight-bold mb-0 p-2 bg-secondary">User Type</p>
                        </div>
                        <div class="col-6 col-md-8">
                            @php
                                $user_of_user_type = config('app.user_of_user_type');

                                foreach ($user_of_user_type as $key => $value) {
                                    if (@$vendor->user_type == $value['value']) {
                                        $usertype = $value['name'];
                                        break;
                                    } else {
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$vendor->user_info->company != null ? @$vendor->user_info->company : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$vendor->user_info->gst_number != null ? @$vendor->user_info->gst_number : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
