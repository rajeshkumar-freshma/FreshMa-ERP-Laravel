            ...
            <div class="card-body">
                ...
                <table class="table align-middle table-row-dashed fs-6 gy-3" id="kt_table_widget_5_table">
                    ...
                    <tbody class="fw-bold text-gray-600">
                        ...
                        @foreach ($sale->sales_order_transactions as $transaction)
                        <tr>
                            <!--begin::Item-->
                            <td>
                            ...
                            <td class="text-end" data-order="58">
                                <span><a href="{{ route('admin.customer.show', $users->id) }}"><i class='fas fa-eye' style='font-size:15px;color:green'></i></a></span>
                            </td>
                            <!--end::Qty-->
                        </tr>
                        @endforeach
                    ...
                    <div class="d-flex justify-content-between mx-0 row mt-1">
                        ...
                        <div class="col-sm-12 col-md-6 float-right">
                            {{ $sales->withQueryString()->links('vendor.pagination.custom') }}
                        </div>
                    </div>
                    @endif
                    <!--end::Table body-->
                                ...
                                @foreach ($sales as $sale)
                                    @foreach ($sale->sales_order_transactions as $transaction)
                                        <tr>
                                            ...
                                            <td class="text-end" data-order="58">
                                                <span><a href="{{ route('admin.payment-transaction-report.index') }}"><i
                                                            class='fas fa-eye'
