<x-default-layout>
    ...
    <form id="add_vendor_form" method="POST" action="{{ route('admin.customer.store') }}"
        ...
        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
            ...
            <div class="tab-content">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-5">
                                    ...
                                    <input type="text" name="user_code"
                                        ...
                                        placeholder="Enter User Code" autocomplete="off" />
                ...
                <!--end::Tab pane-->
                @include('pages.master.vendor.advanced')
                @include('pages.master.vendor.commission_percentage')
            </div>
            <!--end::Tab content-->
