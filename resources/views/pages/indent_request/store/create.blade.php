<x-default-layout>
   ...
   @include('pages.partials.common-toolbar', [
       'title' => 'Add Store Indent Request',
       'menu_1_link' => route('admin.store-indent-request.index'),
       'menu_2' => 'Add Store Indent Request',
   ])
@endsection
    <!--begin::Basic info-->
    <div class="card">
        ...
        <div id="item_details" class="collapse show">
            ...
            <form id="item_details_form" class="form" method="POST"
                action="{{ route('admin.store-indent-request.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
                <div class="card-body border-top px-9 py-4">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <div class="mb-5">
                                @php
                                    $invoice_number = commoncomponent()->invoice_no('store_indent');
                                @endphp
                                <label for="ir_code"
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                <label for="ir_request_date"
                                    class=" form-label required">{{ __('Request Date') }}</label>
                        ...
                        <div class="col-md-4">
                            <div class="mb-5">
                                <label for="ir_expected_date"
                                    class="form-label required">{{ __('Expected Date') }}</label>
                                <div class="input-group">
