<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            'title' => 'Add Staff Advance',
            'menu_1_link' => route('admin.staff-advance.index'),
            'menu_2' => 'Add Staff Advance',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        ...
        <div id="staff_advanced" class="collapse show">
            <!--begin::Form-->
            <form id="staff_advanced_form" class="form" method="POST" action="{{ route('admin.staff-advance.store') }}"
                    ...
                    <div class="row mb-3">
                                        ...
                                        <select name="payment_type_id" id="payment_type_id"
                                            ...
                                            @foreach (@$paymentTypes as $key => $types)
                                                <option data-kt-flag="{{ $types->id }}" value="{{ $types->id }}"
                                                    {{ $types->id == old('payment_type_id') ? 'selected' : '' }}>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    <input id="date" type="button"   data-placeholder="{{ __('Select Date..') }}"
                                        class="form-control form-control-sm form-control-solid fsh_flat_datepicker " placeholder="Enter Date"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    <input id="amount" type="text" value="{{ old('amount') }}" placeholder="Enter Amount"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                <label for="staff_advance_documents"
                                    class="form-label">{{ __('Attachment') }}</label>
                                <div class="input-group">
                                    <input id="staff_advance_documents" type="file"
                                        class="form-control form-control-sm form-control-solid"
                                        name="staff_advance_documents"
                                        value="{{ old('staff_advance_documents') }}" />
                                    <span class="input-group-text border-0">
                                        <i class="fas fa-calendar"></i>
                                    </span>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <textarea name="notes" id="notes" rows="5" class="form-control form-control-solid">{{ old('notes') }}</textarea>
                                @if ($errors->has('notes'))
                                    <span class="fv-plugins-message-container invalid-feedback" role="alert">
