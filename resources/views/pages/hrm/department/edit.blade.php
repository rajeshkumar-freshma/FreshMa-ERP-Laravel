<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            ...
            'menu_1_link' => route('admin.department.index'),
            'menu_2' => 'Edit Departments',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Edit Department'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="department" class="collapse show">
            <!--begin::Form-->
            <form id="department_form" class="form" method="POST" action="{{ route('admin.department.update',@$department->id) }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="name"
                                    ...
                                    placeholder="Name" value="{{old('name',@$department->name)  }}" required />
                                @if ($errors->has('name'))
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                ...
                                <input class="form-check-input w-45px h-30px" type="checkbox" id="status"
                                    name="status" value="1" {{ old('status', @$department->status) ? 'checked' : '' }} />
                                ...
                                <div class="input-group input-group-sm flex-nowrap">
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        ...
                                        <textarea name="description" class="form-control form-control-sm form-control-solid" id="description"
                                            placeholder="Enter description" required>{{ old('description',@$department->description) }}</textarea>
                                    </div>
                                </div>
                ...
                @include('pages.partials.form_footer', [
                    'is_save' => true,
                    'back_url' => route('admin.department.index'),
                ])
                <!--end::Actions-->
            </form>
            <!--end::Form-->
