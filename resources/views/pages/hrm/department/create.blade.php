<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            ...
            'menu_2' => 'Add Departments',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Department'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="department" class="collapse show">
            <!--begin::Form-->
            <form id="department_form" class="form" method="POST" action="{{ route('admin.department.store') }}"
