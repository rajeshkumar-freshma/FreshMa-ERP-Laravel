<x-default-layout>
    ...
    @section('_toolbar')
        @include('pages.partials.common-toolbar', [
            ...
            'menu_2' => 'Edit Designation',
        ])
    @endsection
    <!--begin::Basic info-->
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Edit Designation'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="designation" class="collapse show">
            <!--begin::Form-->
            <form id="designation_form" class="form" method="POST" action="{{ route('admin.designation.update',@$designation->id) }}"
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="row">
                                <input type="text" name="name"
                                    ...
                                    placeholder="Name" value="{{old('name',@$designation->name)  }}" required />
                                @if ($errors->has('name'))
                        ...
                        <div class="col-lg-8 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch fv-row">
                                ...
                                <input class="form-check-input w-45px h-30px" type="checkbox" id="status"
                                    name="status" value="1" {{ old('status', @$designation->status) ? 'checked' : '' }} />
