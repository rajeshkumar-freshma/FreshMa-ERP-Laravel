<x-default-layout>
    <div class="card">
        <div class="card-header">
            <h3 class="card-title px-sm-4 px-md-1 px-lg-2 px-xl-3">leave Details</h3>
        ...
        <div class="card-body">
            <div class="row text-center px-sm-4 px-md-1 px-lg-2 px-xl-3">
                    ...
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            @foreach ($employee as $item)
                                @if (@$item->id == $leaves->employee_id)
                                    <p class="mb-0 p-2 text-md font-weight-bold">
                                        {{ @$item->firs_name != null ? @$item->firs_name : '-' }}</p>
                                @endif
                            @endforeach
                        </div>
                    </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        <div class="col-6 col-md-4 p-0">
                            <p class="font-weight-bold mb-0 p-2 bg-secondary">Leave Type</p>
                        </div>
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                @foreach ($leave_types as $item)
                                    @if (@$item->id == $leaves->leave_type)
                                        <p class="mb-0 p-2 text-md font-weight-bold">
                                            {{ @$item->name != null ? @$item->name : '-' }}</p>
                                    @endif
                                @endforeach
                            </p>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$leaves->applied_on != null ? @$leaves->applied_on : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="row border border-default h-100">
                        ...
                        <div class="col-6 col-md-8">
                            <p class="mb-0 p-2 text-md font-weight-bold">
                                {{ @$leaves->start_date != null ? @$leaves->start_date : '-' }}
                            </p>
                        </div>
                    </div>
                </div>
