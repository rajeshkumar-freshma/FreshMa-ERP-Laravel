<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Staff Advance'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="staff_advance" class="collapse show">
            <!--begin::Form-->
            <form id="staff_advance_form" class="form" method="POST" action="{{ route('admin.staff-advance.store') }}" enctype="multipart/form-data">
                @csrf
                <!--begin::Card body-->
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="first_name" value="{{ old('first_name') }}" class="form-control form-control-sm form-control-solid" id="first_name" placeholder="Enter Name" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="last_name" value="{{ old('last_name') }}" class="form-control form-control-sm form-control-solid" id="last_name" placeholder="Enter Name" required/>
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="phone_number" value="{{ old('phone_number') }}" class="form-control form-control-sm form-control-solid" id="phone_number" placeholder="Enter Phone Number" required />
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="email" name="email" value="{{ old('email') }}" class="form-control form-control-sm form-control-solid" id="email" placeholder="Enter Email" required/>
                                @if ($errors->has('email'))
                                    <span class="fv-plugins-message-container invalid-feedback" role="alert">
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="password" name="password" value="{{ old('password') }}" class="form-control form-control-sm form-control-solid" id="password" placeholder="Enter Password" required />
                                    ...
                                    <div class="overflow-hidden flex-grow-1">
                                        <select name="country_id" id="country-dropdown" aria-label="{{ __('Select Country') }}" data-control="select2" data-placeholder="{{ __('Select Country..') }}" class="form-select form-select-sm form-select-solid" data-allow-clear="true" required>
                                            ...
                                            @foreach ($countries as $key => $value)
                                                <option data-kt-flag="{{ $value->id }}" value="{{ $value->id }}" {{ $value->id == old('country_id') ? 'selected' : '' }}>{{ $value->currency_code }} - {{ $value->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
