<x-default-layout>
    ...
    <div class="card">
        <!--begin::Card header-->
        @include('pages.partials.form_header', ['header_name' => 'Add Employee'])
        <!--begin::Card header-->

        <!--begin::Content-->
        <div id="employee_details" class="collapse show">
            <!--begin::Form-->
            <form id="employee_details_form" class="form" method="POST" action="{{ route('admin.employee.store') }}"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="first_name" value="{{ old('first_name') }}"
                                    class="form-control form-control-sm form-control-solid" id="first_name"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <input type="text" name="last_name" value="{{ old('last_name') }}"
                                    class="form-control form-control-sm form-control-solid" id="last_name"
                        ...
                        <div class="col-md-6">
                            <div class="mb-5">
                                ...
                                <div class="input-group">
                                    <input id="joined_at" type="text"
                                        class="form-control form-control-solid fsh_flat_datepicker" name="joined_at"
                ...
                <hr>
                @include('pages.hrm.employee.employee_documents', ['staff' => null])
                <hr>
                @include('pages.hrm.employee.employee_detail', ['data' => old('employee_detail_store')])
                ...
                @include('pages.partials.form_footer', [
                    'is_save' => true,
                    'back_url' => route('admin.employee.index'),
                ])
                <!--end::Actions-->
            </form>
            <!--end::Form-->
