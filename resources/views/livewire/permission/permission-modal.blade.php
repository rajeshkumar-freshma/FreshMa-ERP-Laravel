            ...
            <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                ...
                <form id="kt_modal_update_permission_form" class="form" action="#" wire:submit.prevent="submit">
                    ...
                    <div class="fv-row mb-7">
                        ...
                        <!--end::Label-->
                        <!--begin::Input-->
                        <input class="form-control form-control-solid" autocomplete="off" placeholder="Enter a permission name" name="name" wire:model.defer="name"/>
                        <!--end::Input-->
                        @error('name')
                    ...
                    <div class="fv-row mb-7">
                        <!--begin::Label-->
                        <label class="fs-6 fw-semibold form-label mb-2">
                            <span class="required">Guard Type</span>
                        </label>
                        <!--end::Label-->
                        <!--begin::Input-->
                        <select name="guard_name" autocomplete="off" id="guard_name" class="form-select form-select-sm form-select-solid" data-allow-clear="true" wire:model.defer="guard_name">
                            <option value="" selected disabled>{{ __('Select Guard Type') }}</option>
