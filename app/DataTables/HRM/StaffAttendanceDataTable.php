...
class StaffAttendanceDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->minifiedAjax('', 'data.date_from = $("#staff_attendance-table-date-from").val(); data.date_to = $("#staff_attendance-table-date-to").val(); data.status = $("#staff_attendance-table-status-filter").val();')
            ->stateSave(false)
            ->responsive()
            ->autoWidth(true)
        // ->selectStyleSingle()
