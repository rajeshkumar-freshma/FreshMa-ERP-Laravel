...
class PayrollTypeDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->minifiedAjax('', 'data.date_from = $("#payroll_types-table-date-from").val(); data.date_to = $("#payroll_types-table-date-to").val(); data.status = $("#payroll_types-table-status-filter").val();')
            ->stateSave(false)
            ->responsive()
            ->autoWidth(true)
        // ->selectStyleSingle()
