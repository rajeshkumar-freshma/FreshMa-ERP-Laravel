...
class LoanCategoryDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->minifiedAjax('', 'data.date_from = $("#loan-category-table-date-from").val(); data.date_to = $("#loan-category-table-date-to").val(); data.status = $("#loan-category-table-status-filter").val();')
            ->stateSave(false)
            ->responsive()
            ->autoWidth(true)
            ->parameters([
