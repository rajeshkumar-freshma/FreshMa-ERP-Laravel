...
class SalesOrderDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->minifiedAjax('', 'data.date_from = $("#salesorder-table-date-from").val(); data.date_to = $("#salesorder-table-date-to").val(); data.status = $("#salesorder-table-status-filter").val(); data.bill_no = $("#bill_no").val(); data.store_id = $("#store_id").val(); data.from_date = $("#from_date").val(); data.to_date = $("#to_date").val();')
            ->stateSave(false)
            ->responsive()
            ->autoWidth(true)
            ->parameters([
