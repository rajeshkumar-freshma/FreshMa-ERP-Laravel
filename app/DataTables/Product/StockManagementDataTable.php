...
class StockManagementDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        return $this->builder()
            ...
            ->minifiedAjax('', 'data.date_from = $("#stockmanagement-table-date-from").val(); data.date_to = $("#stockmanagement-table-date-to").val(); data.status = $("#stockmanagement-table-status-filter").val();')
            ->stateSave(false)
            ->responsive()
            ->autoWidth(true)
            ->parameters([
