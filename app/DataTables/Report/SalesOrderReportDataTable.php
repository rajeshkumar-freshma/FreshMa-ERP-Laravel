...
class SalesOrderReportDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->addColumn('vendor_id', function (SalesOrder $model) {
                return $model->vendor->id ?? ''; // Fix the typo in 'first_name'
            })
            ->addColumn('payment_status', function (SalesOrder $model) {
                $sales_payment_status = $model->payment_status;
                return view('pages.partials.statuslabel', compact('sales_payment_status'));
            });
    }
    ...
    public function query(SalesOrder $model): QueryBuilder
    {
        ...
        if ($this->request()->delivered_date != null) {
            $query = $query->where('delivered_date', $this->request()->delivered_date);
        }
    ...
    public function html(): HtmlBuilder
    {
        ...
        if (Auth::check() &&  Auth::user()->can('Sales Order Report Download')) {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('total_given_quantity'),
