...
class WarehouseIndentRequestDataTable extends DataTable
{
    ...
    public function html(): HtmlBuilder
    {
        ...
        return $this->builder()
            ...
            ->minifiedAjax('', 'data.date_from = $("#warehouseindentrequest-table-date-from").val(); data.date_to = $("#warehouseindentrequest-table-date-to").val(); data.status = $("#warehouseindentrequest-table-status-filter").val();')
            ->stateSave(false)
            ->responsive()
            ->autoWidth(true)
            ->parameters([
