...
class StoreIndentRequest extends Model
{
    ...
    {
        return $this->hasOne(Store::class, 'id', 'store_id')->select('id', 'store_name', 'store_code');
    }

    public function store_indent_product_details()
    {
        return $this->hasMany(StoreIndentRequestDetail::class, 'store_indent_request_id', 'id');
    }
